...
<head>
    ...
    <title>Inventario - Gestión Administrativa</title>
</head>
                ...
                <div class="page-title-box">
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            <div class="col-md-8">
                                <h4 class="page-title mb-1">Gestión de Inventario</h4>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <button class="btn btn-secondary waves-effect waves-light mb-4" id="btnnuevo">
                                            <i class="fa fa-plus-square me-2"></i> Nuevo Ítem
                                        </button>

                                        <!-- Tabla DataTable -->
                                        <table id="inventario_data" class="table table-striped table-bordered dt-responsive nowrap" style="width: 100%">
                                            <thead>
                                                <tr>
                                                    <th>Nombre</th>
                                                    <th>Categoría</th>
                                            ...
                                            <tbody>
                                                <!-- Los datos se cargan dinámicamente desde inventario.js -->
                                            </tbody>
                                        </table>
                                    </div>
                                </div>
