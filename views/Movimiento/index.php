...
<head>
    ...
    <title>Movimientos de Inventario - Gestión Administrativa</title>
</head>
                ...
                <div class="page-title-box">
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            <div class="col-md-8">
                                <h4 class="page-title mb-1">Gestión de Movimientos</h4>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <!-- Tabla DataTable -->
                                        <table id="movimiento_data" class="table table-striped table-bordered dt-responsive nowrap" style="width: 100%">
                                            <thead>
                                                <tr>
                                                    <th>Fecha</th>
                                                    <th>Ítem</th>
                                            ...
                                            <tbody>
                                                <!-- Los datos se cargan dinámicamente desde movimiento.js -->
                                            </tbody>
                                        </table>
                                    </div>
                                </div>
