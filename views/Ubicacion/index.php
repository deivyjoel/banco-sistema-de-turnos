...
<head>
    ...
    <title>Ubicaciones - Gestión de Inventario</title>
</head>
                ...
                <div class="page-title-box">
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            <div class="col-md-8">
                                <h4 class="page-title mb-1">Mantenimiento de Ubicaciones</h4>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <button class="btn btn-secondary waves-effect waves-light mb-4" id="btnnuevo">
                                            <i class="fa fa-plus-square me-2"></i> Nueva Ubicación
                                        </button>

                                        <!-- Tabla DataTable -->
                                        <table id="ubicacion_data" class="table table-striped table-bordered dt-responsive nowrap" style="width: 100%">
                                            <thead>
                                                <tr>
                                                    <th>Nombre</th>
                                                    <th>Descripción</th>
                                            ...
                                            <tbody>
                                                <!-- Los datos se cargan dinámicamente desde ubicacion.js -->
                                            </tbody>
                                        </table>
                                    </div>
                                </div>
